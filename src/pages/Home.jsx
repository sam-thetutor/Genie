          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">AI-Powered Chat</h3>
                  <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
                    Generate content with our advanced AI system. Upload documents and get context-aware responses.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">Campaign Management</h3>
                  <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
                    Create and manage campaigns across multiple platforms. Schedule posts and track performance.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">Analytics</h3>
                  <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">Multi-Platform Support</h3>
                  <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
                    Manage content across Twitter, Discord, and Telegram from a single dashboard.
                  </p>
                </div>
              </div>
            </div>
